                ...
                <div class="col">
                    ...
                    <div style="margin-bottom: 1.5rem">
                        ...
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Quality Haircut</h3>
                              <p class="desc">30 min</p>
                              <p class="desc">A regular shape up with a tidy back and sides and scissors on top.</p>
                              <br>
                              <h4 class="price">400 SEK</h4>
                            </div>
                        </div>
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Premium Haircut</h3>
                              <p class="desc">45 min</p>
                              <p class="desc">For medium-lenght and classic styles that require a bit more maintenance.</p>
                              <br>
                              <h4 class="price">550 SEK</h4>
                            </div>
                        </div>
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Clippers Only</h3>
                              <p class="desc">15 min</p>
                              <p class="desc">Brisk, professional cut for when time is of the essence.</p>
                              <br>
                              <h4 class="price">200 SEK</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 1.5rem">
                        ...
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Longer Haircut</h3>
                              <p class="desc">1 hour</p>
                              <p class="desc">For a complete restyle, or if you have longer, textured hair.</p>
                              <br>
                              <h4 class="price">750 SEK</h4>
                            </div>
                        </div>
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Skin Fade with Haircut</h3>
                              <p class="desc">45 min</p>
                              <p class="desc">Popular service for achieving the tightest skin fade.</p>
                              <br>
                              <h4 class="price">550 SEK</h4>
                            </div>
                        </div>
                    ...
                    <div style="margin-bottom: 1.5rem">
                        ...
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Quality Beard Trim</h3>
                              <p class="desc">15 min</p>
                              <p class="desc">One grade all over beard trim.</p>
                              <br>
                              <h4 class="price">200 SEK</h4>
                            </div>
                        </div>
                        <div class="card" style="margin-bottom: 0.7rem">
                            <div class="card-body">
                              <h3 class="services">Premium Beard Trim</h3>
                              <p class="desc">30 min</p>
                              <p class="desc">Trimming & Shaping for longer beards and moustaches.</p>
                              <br>
                              <h4 class="price">350 SEK</h4>
                            </div>
                        </div>
                    </div>
