...
public class Hairsalon_GUI {
    ...
    public void performCalculationWithoutCaching() {
        Result newResult = updateResult();
        updateLabels(newResult);
    }
        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                long totalTime = PerformanceTester.runPerformanceTest(() -> {
                    performCalculationWithoutCaching();
                });

                System.out.println("Total execution time without caching: " + totalTime + " nanoseconds");
            }
        });
    }
}
